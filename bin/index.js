...
var L2, h2, D, T, _2, E2, R2 = (s, e) => () => (e || s((e = { exports: {} }).exports, e), e.exports), N2 = (s, e, r, t) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let i of T(e))
      !E2.call(s, i) && i !== r && h2(s, i, { get: () => e[i], enumerable: !(t = D(e, i)) || t.enumerable });
  return s;
}, j2 = (s, e, r) => (r = s != null ? L2(_2(s)) : {}, N2(e || !s || !s.__esModule ? h2(r, "default", { value: s, enumerable: true }) : r, s)), k, x2, u, J, P2 = function(s) {
  return s;
}, S = function() {
  throw new Error("Not implemented");
}, g2, y2, q, B, G, H, K, Q, U, V, X, Y, Z, $, I, O;
var init_path = __esm(() => {
  L2 = Object.create;
  ...
  k = R2((W, w2) => {
            ...
            if (i !== l2 - 1 && a2 === 2) {
              if (r.length < 2 || t !== 2 || r.charCodeAt(r.length - 1) !== 46 || r.charCodeAt(r.length - 2) !== 46) {
                if (r.length > 2) {
                  var f = r.lastIndexOf("/");
                  if (f !== r.length - 1) {
                    f === -1 ? (r = "", t = 0) : (r = r.slice(0, f), t = r.length - 1 - r.lastIndexOf("/")), i = l2, a2 = 0;
                    continue;
                  }
    ...
    var m2 = { resolve: function() {
      ...
      for (var l2 = r.length, f = l2 - n, c = a2 < f ? a2 : f, d2 = -1, o2 = 0;o2 <= c; ++o2) {
        ...
        var A2 = e.charCodeAt(t + o2), z = r.charCodeAt(n + o2);
        if (A2 !== z)
          break;
        A2 === 47 && (d2 = o2);
      }
      ...
      if (r !== undefined && r.length > 0 && r.length <= e.length) {
        ...
        for (n = e.length - 1;n >= 0; --n) {
          ...
          if (c === 47) {
            ...
            f === -1 && (a2 = false, f = n + 1), l2 >= 0 && (c === r.charCodeAt(l2) ? --l2 === -1 && (i = n) : (l2 = -1, i = f));
        }
      ...
      for (var r = -1, t = 0, i = -1, a2 = true, n = 0, l2 = e.length - 1;l2 >= 0; --l2) {
        ...
        i === -1 && (a2 = false, i = l2 + 1), f === 46 ? r === -1 ? r = l2 : n !== 1 && (n = 1) : r !== -1 && (n = -1);
      }
      ...
      for (var n = -1, l2 = 0, f = -1, c = true, d2 = e.length - 1, o2 = 0;d2 >= a2; --d2) {
        ...
        f === -1 && (c = false, f = d2 + 1), t === 46 ? n === -1 ? n = d2 : o2 !== 1 && (o2 = 1) : n !== -1 && (o2 = -1);
      }
      return n === -1 || f === -1 || o2 === 0 || o2 === 1 && n === f - 1 && n === l2 + 1 ? f !== -1 && (l2 === 0 && i ? r.base = r.name = e.slice(1, f) : r.base = r.name = e.slice(l2, f)) : (l2 === 0 && i ? (r.name = e.slice(1, n), r.base = e.slice(1, f)) : (r.name = e.slice(l2, n), r.base = e.slice(l2, f)), r.ext = e.slice(n, f)), l2 > 0 ? r.dir = e.slice(0, l2 - 1) : i && (r.dir = "/"), r;
  ...
  u.parse ??= S;
  J.parse ??= S;
  g2 = { resolve: u.resolve.bind(u), normalize: u.normalize.bind(u), isAbsolute: u.isAbsolute.bind(u), join: u.join.bind(u), relative: u.relative.bind(u), toNamespacedPath: P2, dirname: u.dirname.bind(u), basename: u.basename.bind(u), extname: u.extname.bind(u), format: u.format.bind(u), parse: u.parse.bind(u), sep: "/", delimiter: ":", win32: undefined, posix: undefined, _makeLong: P2 };
  y2 = { sep: "\\", delimiter: ";", win32: undefined, ...g2, posix: g2 };
  g2.win32 = y2.win32 = y2;
  g2.posix = g2;
  q = g2;
  ({ resolve: B, normalize: G, isAbsolute: H, join: K, relative: Q, toNamespacedPath: U, dirname: V, basename: X, extname: Y, format: Z, parse: $, sep: I, delimiter: O } = g2);
});
...
function run() {
  ...
  program2.name("wahyu").description("Tool untuk mempercepat development").version(package_default.version);
  program2.command("hello").description('Menampilkan pesan "Halo, Dunia!"').action(() => {
