...
const createConfig = (
    ...
    try {
        ...
        console.error(chalk.red(`Error creating configuration file: ${error instanceof Error ? error.message : 'Unknown error'}`));
        throw error;
    }
};
...
const updateConfig = (
    ...
    try {
        ...
        console.error(chalk.red(`Error updating configuration file: ${error instanceof Error ? error.message : 'Unknown error'}`));
        throw error;
    }
};
...
const readConfig = (filePath: string): Config | null => {
    try {
        ...
        console.error(chalk.red(`Error reading configuration file: ${error instanceof Error ? error.message : 'Unknown error'}`));
        throw error;
    }
};
